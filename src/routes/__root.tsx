...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI-powered mobile app for managing users, roles, and AI analysis with real-time reporting and 3D maps." },
      { property: "og:description", content: "AI-powered mobile app for managing users, roles, and AI analysis with real-time reporting and 3D maps." },
      { name: "twitter:description", content: "AI-powered mobile app for managing users, roles, and AI analysis with real-time reporting and 3D maps." },
