...
const dict: Dict = {
  ...
  "nav.admin.activity": { ar: "السجل", en: "Activity" },
  "admin.activity.title": { ar: "سجل النشاط", en: "Activity Log" },
  "admin.activity.empty": { ar: "لا يوجد نشاط بعد.", en: "No activity yet." },
  "admin.users.search": { ar: "ابحث بالاسم أو UUID", en: "Search by name or UUID" },
  "admin.users.name": { ar: "الاسم", en: "Name" },
  "admin.users.tier": { ar: "الاشتراك", en: "Subscription" },
  "admin.users.joined": { ar: "تاريخ الانضمام", en: "Joined" },
  "admin.claim.title": { ar: "لا يوجد مشرف بعد", en: "No admin assigned yet" },
  "admin.claim.desc": { ar: "بصفتك أول مستخدم، يمكنك المطالبة بصلاحيات المشرف.", en: "As the first user, you can claim admin privileges." },
  "admin.claim.btn": { ar: "أصبح مشرفًا", en: "Claim admin" },
  "admin.claim.ok": { ar: "تم منحك صلاحيات المشرف", en: "Admin granted" },
  "admin.claim.taken": { ar: "تم تعيين مشرف بالفعل", en: "An admin already exists" },
  "admin.ai.usage": { ar: "استهلاك الذكاء الاصطناعي (آخر 30 يومًا)", en: "AI Usage (last 30 days)" },
  "admin.ai.calls": { ar: "الاستدعاءات", en: "Calls" },
  "admin.ai.tokens_in": { ar: "رموز الإدخال", en: "Input tokens" },
  "admin.ai.tokens_out": { ar: "رموز الإخراج", en: "Output tokens" },
  "admin.ai.credits": { ar: "الرصيد المستهلك", en: "Credits used" },
  "admin.ai.model": { ar: "النموذج", en: "Model" },
